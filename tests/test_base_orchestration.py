...
class TestPatternExecutor:
    ...
    def test_validate_base_config_valid(self):
        ...
        valid_config = {
            ...
            "version": "1.0",
            "agents": [
                {"type": "intake", "name": "Intake Agent", "required": True, "timeout_seconds": 30},
                {"type": "credit", "name": "Credit Agent", "required": True, "timeout_seconds": 60},
            ],
        }
    ...
    def test_validate_base_config_empty_agents(self):
        ...
        invalid_config = {"name": "test_pattern", "pattern_type": "sequential", "version": "1.0", "agents": []}
    ...
    def test_validate_base_config_unknown_agent_type(self):
        ...
        invalid_config = {
            ...
            "pattern_type": "sequential",
            "version": "1.0",
            "agents": [{"type": "nonexistent", "name": "Unknown Agent", "required": True, "timeout_seconds": 30}],
        }
...
class TestHandoffValidationService:
    ...
    def test_check_handoff_conditions_no_rule_for_agent(self):
        ...
        handoff_rules = {"other_agent": {"conditions": ["status == 'complete'"]}}
    ...
    def test_check_handoff_conditions_simple_pass(self):
        ...
        handoff_rules = {"intake": {"conditions": ["validation_status == 'COMPLETE'"]}}
    ...
    def test_check_handoff_conditions_multiple_pass(self):
        ...
        self.sample_context.set_agent_result("credit", {"credit_score": 750, "verification_status": "VERIFIED"}, 2.0)

        handoff_rules = {"credit": {"conditions": ["credit_score >= 650", "verification_status == 'VERIFIED'"]}}
    ...
    def test_check_handoff_conditions_multiple_partial_fail(self):
        ...
        # Set up context with credit result
        self.sample_context.set_agent_result(
            "credit",
            {
    ...
    def test_check_handoff_conditions_complex_expression(self):
        ...
        self.sample_context.set_agent_result(
            "income", {"annual_income": 120000, "employment_status": "verified", "debt_to_income_ratio": 0.25}, 2.5
        )

        handoff_rules = {"income": {"conditions": ["annual_income > 100000 and debt_to_income_ratio < 0.4"]}}
    ...
    def test_check_handoff_conditions_no_agent_result(self):
        ...
        handoff_rules = {"income": {"conditions": ["annual_income > 50000"]}}
    ...
    def test_check_handoff_conditions_invalid_condition(self):
        ...
        handoff_rules = {"risk": {"conditions": ["invalid_syntax++"]}}
...
class TestAgentExecutionService:
    ...
    async def test_execute_agent_setup(self):
        ...
        agent_config = {"type": "intake", "name": "Intake Agent", "timeout_seconds": 30}
    ...
    def test_agent_config_timeout_extraction(self):
        ...
        agent_config_with_timeout = {"type": "credit", "name": "Credit Agent", "timeout_seconds": 60}

        agent_config_without_timeout = {"type": "income", "name": "Income Agent"}
