...
class MCPTestHelpers:
    ...
    @staticmethod
    def create_mock_financial_calculation(calculation_type: str = "dti_calculation") -> dict[str, Any]:
        """Create mock financial calculation result."""
        base_result = {"calculation_timestamp": "2023-08-11T10:30:00Z", "type": calculation_type}
    ...
    @staticmethod
    def validate_response_structure(response: dict[str, Any], required_fields: list[str], response_type: str) -> bool:
...
def mock_financial_service():
    ...
    service.calculate_debt_to_income_ratio.return_value = MCPTestHelpers.create_mock_financial_calculation(
        "dti_calculation"
    )
    service.calculate_monthly_payment.return_value = MCPTestHelpers.create_mock_financial_calculation(
        "payment_calculation"
    )
...
class LoanApplicationTestData:
    ...
    def excellent_credit_application() -> dict[str, Any]:
        ...
        return {
            ...
            "credit_profile": {"credit_score": 780, "utilization": 0.15, "payment_history": 0.98, "delinquencies": 0},
            "financial": {"monthly_income": 10000, "monthly_debt": 800, "liquid_assets": 50000},
            "loan_request": {"amount": 400000, "purpose": "home_purchase", "term_months": 360},
        }
    ...
    def marginal_credit_application() -> dict[str, Any]:
        ...
        return {
            ...
            "credit_profile": {"credit_score": 650, "utilization": 0.45, "payment_history": 0.85, "delinquencies": 1},
            "financial": {"monthly_income": 4583, "monthly_debt": 1200, "liquid_assets": 8000},
            "loan_request": {"amount": 180000, "purpose": "home_purchase", "term_months": 360},
        }
    ...
    def high_risk_application() -> dict[str, Any]:
        ...
        return {
            ...
            "credit_profile": {"credit_score": 580, "utilization": 0.85, "payment_history": 0.65, "delinquencies": 3},
            "financial": {"monthly_income": 3167, "monthly_debt": 1800, "liquid_assets": 1500},
            "loan_request": {"amount": 150000, "purpose": "debt_consolidation", "term_months": 240},
        }
