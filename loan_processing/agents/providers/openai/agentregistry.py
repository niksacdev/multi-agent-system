...
class MCPServerFactory:
    ...
    def get_server(cls, server_type: str) -> MCPServerSse:
        ...
        if server_type not in cls._server_cache:
            logger.info("Creating new MCP server instance", server_type=server_type, component="mcp_server_factory")
            cls._server_cache[server_type] = cls._create_server(server_type)
        else:
            logger.debug("Using cached MCP server instance", server_type=server_type, component="mcp_server_factory")
    ...
    def _create_server(cls, server_type: str) -> MCPServerSse:
        ...
        logger.info("Creating MCP server from configuration", server_type=server_type, component="mcp_server_factory")
...
class AgentRegistry:
    ...
    def create_configured_agent(self, agent_type: str, model: str | None = None) -> Agent:
        ...
        """
        logger.info("Creating configured agent", agent_type=agent_type, model=model, component="agent_registry")
        ...
        try:
            ...
            logger.info(
                "Agent model configuration determined",
                agent_type=agent_type,
            ...
            logger.error(
                "Failed to create configured agent",
                agent_type=agent_type,
                error_message=str(e),
                error_type=type(e).__name__,
                component="agent_registry",
    ...
    def reload_configuration(cls) -> None:
        ...
        try:
            ...
            logger.info(
                "Configuration reloaded successfully", cleared_cache_entries=cache_size, component="agent_registry"
            )
