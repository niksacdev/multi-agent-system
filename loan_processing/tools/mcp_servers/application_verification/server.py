...
logger.info("Application Verification MCP Server initialized", 
...
async def retrieve_credit_report(applicant_id: str, full_name: str, address: str) -> str:
    ...
    logger.info("Credit report request", 
               applicant_id=applicant_id, component="mcp_server")
...
async def verify_employment(applicant_id: str, employer_name: str, position: str) -> str:
    ...
    logger.info("Employment verification request", 
               applicant_id=applicant_id, component="mcp_server")
...
async def get_tax_transcript_data(applicant_id: str, tax_year: int) -> str:
    ...
    logger.info("Tax transcript request", 
               applicant_id=applicant_id, tax_year=tax_year, component="mcp_server")
...
if __name__ == "__main__":
    ...
    if transport == "sse":
        logger.info("Starting Application Verification MCP Server", 
                   transport="sse", url="http://localhost:8010/sse", component="mcp_server")
    else:
        logger.info("Starting Application Verification MCP Server", 
